...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','dk.napp.nui.js')
	...
	f = os.path.join(cwd,'Classes','DkNappNuiModuleAssets.m')
	c = open(f).read()
...
ignoreFiles = ['.DS_Store','.gitignore','libTitanium.a','titanium.jar','README','dk.napp.nui.js']
